...
#forward stepwise
    ...
    def gan_oversample(
        ...
        try:
            ...
            # Already roughly balanced → no GAN
            ...
            # a) Forcibly convert all features to numeric (non-numeric → NaN)
       ...
       # ==================== CUSTOMER SEGMENTATION PAGE ====================
        ...
        with tab2:
            ...
            with tab3:
                ...
                with cB:
                    scale = st.checkbox("Standardize features", value=True, help="Recommended for K-means.", key="km_scale")
                with cC:
